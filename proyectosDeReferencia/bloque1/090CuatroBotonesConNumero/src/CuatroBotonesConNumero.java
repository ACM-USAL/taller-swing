...
public class CuatroBotonesConNumero implements ActionListener {
	private JTextField texto;
	public CuatroBotonesConNumero() {
		/*
	...
	{
		texto.setText(ae.getActionCommand());
	}
	public static void main(String[] args) {
		CuatroBotonesConNumero c = new CuatroBotonesConNumero();
	}
}
